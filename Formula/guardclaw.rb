...
class Guardclaw < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/TakeInterestInc/agent-guardian/releases/download/v0.2.7/guardclaw-darwin-arm64.tar.gz"
      sha256 "1bb7a5671403dd6fdd85c9ba53918dc584abe2016b17c7cb9460abc604e07997"
    else
      url "https://github.com/TakeInterestInc/agent-guardian/releases/download/v0.2.7/guardclaw-darwin-amd64.tar.gz"
      sha256 "8ddf86c2af349076005832900e6a49c9baa4ccd236aae4275cf0bf28ba082bd7"
    end
  end

  on_linux do
    url "https://github.com/TakeInterestInc/agent-guardian/releases/download/v0.2.7/guardclaw-linux-amd64.tar.gz"
